...
ActiveRecord::Schema.define(version: 20150425171321) do
  ...
  add_index "attachments", ["attachment_category_id"], name: "index_attachments_on_attachment_category_id", using: :btree
